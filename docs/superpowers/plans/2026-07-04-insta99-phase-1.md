...
- [ ] Scaffold an Expo TypeScript project in the repository root.
- [ ] Install required Phase 1 dependencies.
- [ ] Configure aliases with `@/*` mapped to `src/*`.
- [ ] Configure ESLint and Prettier.
- [ ] Configure NativeWind and Tailwind.
- [ ] Add environment typing without real secrets.
- [ ] Add source folders with placeholder `.gitkeep` files where a folder has no implementation yet.
- [ ] Run `npm run lint`, `npm run typecheck`, and `npm test`.
- [ ] Commit with `chore: bootstrap expo foundation`.
...
- [ ] Write tests for token exports and component render basics.
- [ ] Implement dark-first tokens and reusable UI components.
- [ ] Run lint, typecheck, tests.
- [ ] Commit with `feat: add dark design system`.
