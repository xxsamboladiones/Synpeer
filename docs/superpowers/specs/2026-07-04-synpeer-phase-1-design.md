# Synpeer Phase 1 Design

## Goal

Build the foundation for Synpeer, a decentralized social network where each user will eventually act as a network node. Phase 1 does not implement social features, P2P networking, blockchain, wallet behavior, backend APIs, or authentication flows.
